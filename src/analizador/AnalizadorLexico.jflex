...
COMENTARIO_LINEAL = {DIAGONAL}{DIAGONAL}({LETRA}|{ESPACIO}|{NUMERO}|{NUMERO_DECIMAL})+{SALTO_LINEA}*
COMENTARIO_MULTILINEAL ={MENOR_QUE}{ADMIRACION}{SALTO_LINEA}*({LETRA}|{ESPACIO}|{NUMERO}|{NUMERO_DECIMAL}|{SALTO_LINEA})+{ADMIRACION}{MAYOR_QUE}{SALTO_LINEA}*
